...
namespace MouseControlObj
{
    ...
    /// 鼠标可控绘制物体基类
    /// </summary>
    public class BaseMouseControlObj : MonoBehaviour
    {
        ...
        {
            StartCoroutine(IMoveXYZ(currentAxisScreenDir, objMoveDir, isGlobal));
        }
        /// <summary>
        /// 开始在某个平面上移动
        /// </summary>
        ...
        {
            StartCoroutine(IMovePanel(controlAxis, isGlobal));
        }
        /// <summary>
        /// 缩放
        /// </summary>
        ...
        {
            StartCoroutine(IScaleXYZ(currentAxisScreenDir, scaleChangeAxis, X, Y, Z));
        }
        /// <summary>
        /// 旋转
        /// </summary>
        ...
        {
            StartCoroutine(IRotXYZ(firstPointDir, axis, controlObjRotAxis));
        }
        private IEnumerator IMoveXYZ(Vector3 currentAxisScreenDir, Vector3 objMoveDir, bool isGlobal)
        {
            while (true)
            {
                ...
                transform.localPosition = Vector3.MoveTowards(transform.localPosition, transform.localPosition + objMoveDir * moveDis, 0.5f);
            ...
            while (true)
            {
                ...
                switch (controlAxis)
                {
                    ...
                    case ControlAxis.XYPanel:
                        ...
                        transform.localPosition = Vector3.MoveTowards(transform.localPosition, transform.localPosition + dir, 0.5f);
                        break;
        ...
        private IEnumerator IRotXYZ(Vector3 firstPointDir, Axis axis, Transform controlObjRotAxis)
        {
            ...
            while (true)
            {
                ...
                transform.Rotate(dir, f * 200 * Time.deltaTime, space);
                controlObjRotAxis.transform.Rotate(dir, f * 200 * Time.deltaTime, space);
                if (dragingAction != null)
                {
                    dragingAction(transform.localPosition, transform.localRotation.eulerAngles, transform.lossyScale.x);
                }
