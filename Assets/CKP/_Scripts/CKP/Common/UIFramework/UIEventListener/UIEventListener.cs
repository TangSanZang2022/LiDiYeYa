...
namespace UIFramework
{
    ...
    public class UIEventListener : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler, IInitializePotentialDragHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IDropHandler, IScrollHandler, IUpdateSelectedHandler, ISelectHandler, IDeselectHandler, IMoveHandler, ISubmitHandler, ICancelHandler
    {
        ...
        //private PointEventHandler _pointEventHandler;

        DoubleClickableUI _doubleClickableUI;
        /// <summary>
        /// 双击UI
        /// </summary>
        DoubleClickableUI doubleClickableUI
        {
            get
            {
               
                if (_doubleClickableUI==null)
                {
                    _doubleClickableUI = GetComponent<DoubleClickableUI>();
                    if (_doubleClickableUI == null)
                    {
                        _doubleClickableUI = gameObject.AddComponent<DoubleClickableUI>();
                    }
                }
                return _doubleClickableUI;
            }
        }
        /// <summary>
        /// 鼠标点击事件
        ...
        public event PointEventHandler pointDoubleClickHandler
        {
            add
            {
                    ...
                    doubleClickableUI.pointDoubleClickHandler+=value;
